...
import com.project.app.repository.specification.impl.AllElementsSpecification;
...
public class ArrayServiceImpl implements ArrayService {
  ...
  public List<AbstractArrayWrapper> getAllSortedBySize() {
    List<AbstractArrayWrapper> all = repository.query(new AllElementsSpecification());
  ...
  public List<AbstractArrayWrapper> getAll() {
    return repository.query(new AllElementsSpecification());
  }
